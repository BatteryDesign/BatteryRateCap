def potential_rate(n):
    """
    This function converts potential vs. capacity data to
    capacity vs c-rate data
...
def Cycle_rate(n):
    ...
    Average the x-values (capacity [mAh]) of corresponding current
    density from the charge/discharge graph
